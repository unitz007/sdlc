...
func TestNewExecutor_SingleWord(t *testing.T) {
	...
	if executor == nil {
		t.Fatal("NewExecutor(context.Background(),\"echo\") returned nil")
	}
	if executor.cmd == nil {
		t.Fatal("NewExecutor(context.Background(),\"echo\").cmd is nil")
	}
}
...
func TestNewExecutor_MultiWord(t *testing.T) {
	...
	if executor == nil {
		t.Fatal("NewExecutor(context.Background(),\"echo hello world\") returned nil")
	}
	if executor.cmd == nil {
		t.Fatal("NewExecutor(context.Background(),\"echo hello world\").cmd is nil")
	}
}
